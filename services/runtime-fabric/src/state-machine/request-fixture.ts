...
export function requestValue(): Record<string, unknown> {
  return {
    ...
    requestId: "rt-v2-fixture",
    providerId: "fixture-provider",
    providerVersion: "1.0.0",
    providerSubject: { kind: "source", id: "fixture-provider", version: "1.0.0", sha256: "1".repeat(64) },
    environmentSubject: { kind: "profile", id: "fixture-runtime-profile", version: "1.0.0", sha256: "2".repeat(64) },
    scope: "local",
    ...
    cleanup: { processCleanup: "required", workspaceCleanup: "delete", sessionCleanup: "required", maxDurationMs: 1_000 },
