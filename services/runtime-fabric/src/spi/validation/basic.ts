import { type RuntimeExit, type RuntimeRequest } from "../../../../../packages/contracts/src/runtime/index.ts";
...
export function validateWorkspaceIdentity(value: unknown): string {
  if (typeof value !== "string" || !SAFE_WORKSPACE_ID.test(value)) {
    throw new Error("provider returned a non-portable content-addressed workspace identity");
  }
  return value;
}
